    ...
    <div class="space-y-6 rounded-lg border border-gray-200 p-4">
        <div>
            ...
            <p class="mb-4 text-sm text-gray-600">
                Click this button and watch the <strong>Actions panel</strong> at the bottom of Storybook. You should see
                "clicked" events logged there.
            </p>
        </div>

        <Button variant="primary" on:click={args.onClick} on:focus={args.onFocus} on:blur={args.onBlur}>
            Test Actions Logging
        </Button>
...
<Story name="Accessibility Examples" asChild>
    <div class="space-y-4">
        <div class="flex flex-wrap gap-4">
            ...
            <Button variant="danger" ariaLabel="Delete item permanently">
                <svg class="h-4 w-4" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
                    <path
                        fill-rule="evenodd"
                        d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9zM4 5a2 2 0 012-2v1a1 1 0 001 1h6a1 1 0 001-1V3a2 2 0 012 2v6.5a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 012 0v3a1 1 0 11-2 0V9zm4 0a1 1 0 112 0v3a1 1 0 11-2 0V9z"
                        clip-rule="evenodd"
                    />
                </svg>
            </Button>
        ...
        <p class="text-sm text-gray-600">
            The first two buttons use aria-label for screen readers since they only contain icons. The third button has
            clear text content and doesn't need additional labels.
        </p>
    </div>
</Story>

<Story name="Form Usage" asChild>
    <form class="space-y-4" on:submit|preventDefault={() => console.log('Form submitted!')}>
        <div>
            <label for="email" class="block text-sm font-medium text-gray-700">Email</label>
            <input
                type="email"
                id="email"
                class="mt-1 block w-full rounded-md border-gray-300 px-3 py-2 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 focus:outline-none"
