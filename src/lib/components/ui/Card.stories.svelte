<script module>
    ...
    const { Story } = defineMeta({
        ...
        args: {
            ...
            content: 'This is the main content of the card. You can edit this text in the controls panel to see how the card adapts to different content lengths.',
...
<Story name="Default" let:args>
    <Card title={args?.title || 'Sample Card Title'} elevated={args?.elevated || false} variant={args?.variant || 'default'} hasFooter={args?.hasFooter !== false} content={args?.content || 'This is the main content of the card. You can edit this text in the controls panel to see how the card adapts to different content lengths.'} footerContent={args?.footerContent || 'Footer content with additional information'} class={args?.class || ''} />
</Story>
...
<Story name="Content Examples" asChild>
    <div class="grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <Card title="Article Preview" elevated variant="primary">
            ...
            <p class="text-primary-700 mb-4">Learn about the latest trends in web development, including component-driven design, utility-first CSS, and modern JavaScript frameworks.</p>
